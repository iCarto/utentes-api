    ...
    (L.Toolbar = (L.Layer || L.Class).extend({
        ...
        onAdd: function(a) {
            ...
            0 === this._calculateDepth() &&
                (b && a.removeLayer(b), (a._toolbars[this._toolbar_type] = this));
        },
        onRemove: function(a) {
        ...
        appendToContainer: function(a) {
            var b,
                ...
                f,
                g,
                h = this.constructor.baseClass + "-" + this._calculateDepth(),
                i = h + " " + this.options.className;
            for (
                this._container = a,
                    this._ul = L.DomUtil.create("ul", i, a),
                    this._disabledEvents = ["click", "mousemove", "dblclick"],
                    e = 0,
                    g = this._disabledEvents.length;
                g > e;
                e++
            )
                L.DomEvent.on(
                    this._ul,
                    this._disabledEvents[e],
                    L.DomEvent.stopPropagation
                );
            for (d = 0, f = this.options.actions.length; f > d; d++)
                (b = this._getActionConstructor(this.options.actions[d])),
                    (c = new b()),
                    c._createIcon(this, this._ul, this._arguments);
        },
        _getActionConstructor: function(a) {
            ...
            return a.extend({
                ...
                enable: function(b) {
                    c._active && c._active.disable(),
                        (c._active = this),
                        a.prototype.enable.call(this, b);
                },
            });
        },
        _hide: function() {
        ...
        _calculateDepth: function() {
            for (var a = 0, b = this.parentToolbar; b; )
                (a += 1), (b = b.parentToolbar);
            return a;
        },
    })),
        (L.toolbar = {});
    ...
    (L.Toolbar.extend = function(a) {
        ...
        (L.ToolbarAction = L.Handler.extend({
            ...
            _createIcon: function(a, b, c) {
                ...
                (this.toolbar = a),
                    (this._icon = L.DomUtil.create("li", "", b)),
                    (this._link = L.DomUtil.create("a", "", this._icon)),
                    (this._link.innerHTML = d.html),
                    this._link.setAttribute("href", "#"),
                    this._link.setAttribute("title", d.tooltip),
                    L.DomUtil.addClass(this._link, this.constructor.baseClass),
                    d.className && L.DomUtil.addClass(this._link, d.className),
                    L.DomEvent.on(this._link, "click", this.enable, this),
                    this._addSubToolbar(a, this._icon, c);
            },
            _addSubToolbar: function(a, b, c) {
                var d = this.options.subToolbar,
                    ...
                    f = this.removeHooks;
                (d.parentToolbar = a),
                    d.options.actions.length > 0 &&
                        ((c = [].slice.call(c)),
                        c.push(this),
                        d.addTo.apply(d, c),
                        d.appendToContainer(b),
                        (this.addHooks = function(a) {
        ...
        (L.Toolbar.Control = L.Toolbar.extend({
            ...
            onAdd: function(a) {
                this._control.addTo(a),
                    L.Toolbar.prototype.onAdd.call(this, a),
                    this.appendToContainer(this._control.getContainer());
            },
            onRemove: function(a) {
                L.Toolbar.prototype.onRemove.call(this, a),
                    this._control.remove
                        ? this._control.remove()
                        : this._control.removeFrom(a);
            },
        })),
        ...
        (L.Toolbar.Popup = L.Toolbar.extend({
            ...
            initialize: function(a, b) {
                L.Toolbar.prototype.initialize.call(this, b),
                    (this._marker = new L.Marker(a, {
                        icon: new L.DivIcon({
            ...
            onAdd: function(a) {
                (this._map = a),
                    this._marker.addTo(a),
                    L.Toolbar.prototype.onAdd.call(this, a),
                    this.appendToContainer(this._marker._icon),
                    this._setStyles();
            },
            onRemove: function(a) {
                a.removeLayer(this._marker),
                    L.Toolbar.prototype.onRemove.call(this, a),
                    delete this._map;
            },
            ...
            _setStyles: function() {
                for (
                    var a,
                        ...
                        e = this._container,
                        f = this._ul,
                        g = L.point(this.options.anchor),
                        h = f.querySelectorAll(".leaflet-toolbar-icon"),
                        i = [],
                        j = 0,
                        k = 0,
                        l = h.length;
                    ...
                    h[k].parentNode.parentNode === f &&
                        (i.push(parseInt(L.DomUtil.getStyle(h[k], "height"), 10)),
                        (j += Math.ceil(
                            parseFloat(L.DomUtil.getStyle(h[k], "width"))
                        )));
                (f.style.width = j + "px"),
                    ...
                    (this._tipContainer.style.width = j + "px"),
                    (this._tip = L.DomUtil.create(
                        "div",
                        "leaflet-toolbar-tip",
                        this._tipContainer
                    )),
                    (a = Math.max.apply(c, i)),
                    (b = parseInt(L.DomUtil.getStyle(this._tip, "width"), 10)),
                    (d = new L.Point(j / 2, a + 0.7071 * b)),
                    (e.style.marginLeft = g.x - d.x + "px"),
                    (e.style.marginTop = g.y - d.y + "px");
            },
        })),

...
ActividadeSchema["Abastecimento"] = [
    {
        fieldname: "tipo",
        message: 'O "tipo de actividadeE não pode estar vazio',
        rules: ["NOT_NULL"],
    },
    {
        fieldname: "c_estimado",
        message:
            'O "consumo estimado" da actividade não tem o formato correcto ou está vazio',
        rules: ["IS_NUMERIC", "INT_LESS_THAN_8", "NOT_NULL"],
    },
    {
        fieldname: "habitantes",
        message:
            'O "número de habitantes" da actividade não tem o formato correcto ou está vazio',
        rules: ["IS_NUMERIC", "INT_LESS_THAN_8", "NOT_NULL"],
    },
    {
        fieldname: "dotacao",
...
ActividadeSchema["Saneamento"] = [
    ...
    {
        fieldname: "habitantes",
        message: 'O "número de habitantes" da actividade não tem o formato correcto'2,
        rules: ["IS_NUMERIC", "INT_LESS_THAN_8"],
    },
];

...
Backbone.SIXHIARA.ViewFacturaHistorico = Backbone.View.extend({
    ...
    id: 'factura-historico-view',

    template: _.template(`
        <li class="factura-historico">
            <small class="label 
            <%
    ...
    setSelected: function() {
        this.$el.find('.factura-historico').addClass('factura-selected');
    },

    removeSelected: function() {
        this.$el.find('.factura-historico').removeClass('factura-selected');
    },

...
Backbone.SIXHIARA.ViewTecnico1 = Backbone.SIXHIARA.View1.extend({
  ...
  <div class="col-xs-12">
    <div id="bt-toolbar" class="btn-group btn-group-justified" role="group">
        ...
        <div class="btn-group" role="group">
            <a id="bt-adicionar" class="btn btn-default" role="button" href="/static/exploracao-new.html?id=<%- id %>">Adicionar</a>
        </div>
        <div class="btn-group" role="group">
            <a class="btn btn-default" role="button" href="/static/exploracao-gps.html">Xeometría</a>
        </div>
        <div class="btn-group" role="group">

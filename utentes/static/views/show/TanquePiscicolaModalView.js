...
Backbone.SIXHIARA.TanquePiscicolaModalView = Backbone.UILib.ModalView.extend({
    customConfiguration: function() {
        ...
        this.listenTo(this.widgetModel, "change:esp_culti", function(
            model,
            value,
            options
        ) {
        ...
        this.listenTo(this.widgetModel, "change:prov_alev", function(
            model,
            value,
            options
        ) {
        ...
        this.listenTo(this.widgetModel, "change:fert_agua", function(
            model,
            value,
            options
        ) {
    ...
    confUpdateAreaVol: function() {
        ...
        this.listenTo(this.widgetModel, "change:cumprimen", function(
            model,
            value,
            options
        ) {
        ...
        this.listenTo(this.widgetModel, "change:largura", function(
            model,
            value,
            options
        ) {
        ...
        this.listenTo(this.widgetModel, "change:profundid", function(
            model,
            value,
            options
        ) {
        ...
        this.listenTo(
            this.widgetModel,
            "change:cumprimen change:largura change:profundid",
            function(model, value, options) {
                ...
                if (cumprimen_exist && largura_exist && profundid_exist) {
                    inputVolume.val(
                        formatter().formatNumber(actualValueVolume, "0[.]00")
                    );
    ...
    confUpdateProdAnu: function() {
        ...
        this.listenTo(this.widgetModel, "change:venda", function(
            model,
            value,
            options
        ) {
        ...
        this.listenTo(this.widgetModel, "change:consumo", function(
            model,
            value,
            options
        ) {
        ...
        this.listenTo(this.widgetModel, "change:venda change:consumo", function(
            model,
            value,
            options
        ) {
            ...
            if (venda_exist && consumo_exist) {
                inputProAnual.val(
                    formatter().formatNumber(actualValueProAnual, "0[.]00")
                );
            } else {
